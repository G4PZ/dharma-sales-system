  ...
  return (
    <>
      ...
      <div className="min-h-screen w-full flex items-center justify-center p-4 sm:p-6 bg-radial-[at_top_right] from-slate-900 via-[#0B192C] to-[#060e18] text-slate-100 relative overflow-hidden select-none">
        ...
        {/* Login Card */}
        <div className="w-full max-w-md bg-white/[0.04] backdrop-blur-xl border border-white/10 rounded-3xl p-8 sm:p-10 shadow-2xl shadow-black/40 relative z-10 flex flex-col items-center text-center">
          ...
          {/* Error Message Alert */}
          {errorMessage && (
            <div className="w-full mb-6 p-4 rounded-2xl bg-rose-500/10 border border-rose-500/20 text-rose-300 text-xs flex items-start gap-3 text-left animate-in fade-in duration-200">
          ...
          <div className="w-full flex flex-col items-center justify-center min-h-[50px] relative">
            {isSubmitting ? (
              <div className="flex items-center justify-center gap-3 py-3 px-6 bg-white/10 rounded-xl border border-white/15 text-slate-200 text-sm font-medium">
          ...
          <div className="mt-8 pt-6 border-t border-white/10 w-full flex items-center justify-center gap-2 text-[11px] text-slate-400">
